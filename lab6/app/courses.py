...
def reviews(course_id):
    ...
    pagination = review_repository.get_course_reviews_paginated(
...
def create_review(course_id):
    ...
    existing_review = review_repository.get_review_by_user_and_course(current_user.id, course_id)
    if existing_review:
    ...
    try:
        # Добавляем отзыв
        review = review_repository.add_review(current_user.id, course_id, rating, text)
    ...
    next_page = request.referrer or url_for('courses.show', course_id=course_id)
